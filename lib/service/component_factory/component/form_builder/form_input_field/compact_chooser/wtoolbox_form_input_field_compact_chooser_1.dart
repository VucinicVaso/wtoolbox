...
class WTFormInputFieldCompactChooser1 extends WTFormInputField {
...
class CompactTextInputFieldState extends State<CompactTextInputField> with WTFormInputFieldBuilder {
  ...
  void onTap() {
    setState(() { backgroundColor = Colors.grey.shade200; });

    Future.delayed(
      const Duration(milliseconds: 100),
      () {
        setState(() { backgroundColor = widget.backgroundColor; });
        widget.suffixAction!();
      }
    );
  }
