...
//@immutable
class WTThemeServiceExtension extends ThemeExtension<WTThemeServiceExtension> {

  WTThemeServiceExtension({
    this.base1,
    this.base2,
    this.text1,
    this.text2,
  ...
  @override
  ThemeExtension<WTThemeServiceExtension> copyWith({
    Color? base1,
    Color? base2,
    Color? text1,
    Color? text2,
    ...
    return WTThemeServiceExtension(
      ...
      shade11:  shade11  ?? this.shade11,
    );
  }

  @override
  ThemeExtension<WTThemeServiceExtension> lerp(covariant ThemeExtension<WTThemeServiceExtension>? other, double t) {
    if(other is! WTThemeServiceExtension) { return this; }
    ...
    return WTThemeServiceExtension(
      ...
      shade11:  Color.lerp(shade11,  other.shade11,  t),
    );
  }
