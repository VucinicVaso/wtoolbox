...
//@immutable
class WTThemeExtension extends ThemeExtension<WTThemeExtension> {
  ...
  @override
  ThemeExtension<WTThemeExtension> lerp(covariant ThemeExtension<WTThemeExtension>? other, double t) {
    if(other is! WTThemeExtension) { return this; }
