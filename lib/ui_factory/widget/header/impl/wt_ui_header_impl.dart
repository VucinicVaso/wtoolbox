...
import '../wt_ui_header.dart';
import '../wt_ui_header_builder.dart';

class WTUIHeaderImpl extends WTUIHeader {
  ...
  Widget? backActionsWidgets() {
    ...
    if(backActionNetworkImage != null || backActionAssetImage != null || backActionMemoryImage != null) {
      if(backActionNetworkImage != null) {
        backActionImageWidget = WTUIHeaderBuilder.createNetworkImage(
          margin: const EdgeInsets.fromLTRB(0.0, 0.0, 5.0, 0.0),
          size: backActionIconSize,
      ...
      if(backActionAssetImage != null) {
        backActionImageWidget = WTUIHeaderBuilder.createAssetsImage(
          margin: const EdgeInsets.fromLTRB(0.0, 0.0, 5.0, 0.0),
          size: backActionIconSize,
      ...
      if(backActionMemoryImage != null) {
        backActionImageWidget = WTUIHeaderBuilder.createMemoryImage(
          margin: const EdgeInsets.fromLTRB(0.0, 0.0, 5.0, 0.0),
          size: backActionIconSize,
